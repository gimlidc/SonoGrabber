...
QVector3D Transform::getOrig(const QMatrix4x4 &transform)
{
    QVector4D in = QVector4D(crop.x(), crop.y(), 0, 1);
    return QVector3D(transform * in);
}

QVector3D Transform::getX(const QMatrix4x4 &transform)
{
    QVector4D in = QVector4D(crop.x()+crop.width(), crop.y(), 0, 1);
    return QVector3D(transform * in);
}

QVector3D Transform::getC(const QMatrix4x4 &transform)
{
    QVector4D in = QVector4D(crop.x()+crop.width()/2, crop.y(), 0, 1);
    return QVector3D(transform * in);
}

QVector3D Transform::getY(const QMatrix4x4 &transform)
{
    QVector4D in = QVector4D(crop.x(), crop.y()+crop.height(), 0, 1);
    return QVector3D(transform * in);
}

QVector3D Transform::getLowest(const QMatrix4x4 &transform)
{
...
qreal Transform::getHeight(const QMatrix4x4 &transform)
{
